...
public class SelectSql {
	...
	public SelectSql where(List<Object> conditionWildcards, String... conditions) {
		this.where = StringConverter.arrayToString(conditions, "AND");
		this.conditionWildcards = conditionWildcards;
		return this;
	}

	public SelectSql orderBy(String orderBy) {
		this.orderBy = orderBy;
		return this;
	}
	
	public SelectSql innerJoin(String table, String criteria) {
